OC.L10N.register(
    ...
    "Leave all fields empty to use default Nextcloud Dropbox OAuth app." : "Lassen Sie alle Felder leer, um die standardmäßige Dropbox-OAuth-App von Nextcloud zu verwenden.",
    "If you want your Nextcloud users to authenticate to Dropbox using your own Dropbox OAuth app, create one in Dropbox." : "Wenn Sie möchten, dass sich Ihre Nextcloud-Benutzer mit Ihrer eigenen Dropbox-OAuth-App bei Dropbox anmelden, erstellen Sie eine in Dropbox.",
    ...
    "If you have trouble authenticating, ask your Nextcloud administrator to check Dropbox admin settings." : "Wenn Sie Probleme bei der Anmeldung haben, bitten Sie Ihre Nextcloud-Administration, die Dropbox-Admin-Einstellungen zu überprüfen.",
