OC.L10N.register(
    "integration_dropbox",
    {
    "Invalid access code" : "Λανθασμένος κωδικός πρόσβασης",
    "Dropbox" : "Dropbox",
    "_%n file was imported from Dropbox storage._::_%n files were imported from Dropbox storage._" : ["Έγινε εισαγωγή %n αρχείου από το χώρο αποθήκευσης του Dropbox.","Έγινε εισαγωγή %n αρχείων από το χώρο αποθήκευσης του Dropbox. "],
