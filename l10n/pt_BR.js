OC.L10N.register(
    ...
    "Dropbox" : "Dropbox",
    "_%n file was imported from Dropbox storage._::_%n files were imported from Dropbox storage._" : ["%n arquivo foi importado do armazenamento do Dropbox.","%n de arquivos foram importados do armazenamento do Dropbox.","%n arquivos foram importados do armazenamento do Dropbox."],
    ...
    "Failed to save Dropbox admin options" : "Falha ao salvar as opções administrativas do Dropbox",
    ...
    "Dropbox developer settings" : "Configurações de desenvolvedor do Dropbox",
    "Make sure your give those permissions to your app:" : "Certifique-se de conceder essas permissões ao seu aplicativo:",
    "No need to add any redirect URI." : "Não há necessidade de adicionar nenhum URI de redirecionamento.",
    "Then set the app key and app secret below." : "Em seguida, defina a chave e o segredo do aplicativo abaixo.",
    "App key" : "Chave do aplicativo",
    "Your Dropbox application key" : "Sua chave do aplicativo do Dropbox",
    ...
    "Disconnect from Dropbox" : "Desconectar do Dropbox",
    ...
    "_{amount} file imported_::_{amount} files imported_" : ["{amount} arquivo importado","{amount} de arquivos importados","{amount} arquivos importados"]
},
